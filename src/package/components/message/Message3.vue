...
export default defineComponent({
  ...
  render() {
    ...
    const closeIcon = showClose ? <i class="iconfont icon-guanbi" onClick={close}></i> : null;
    const spanDom = !dangerouslyUseHTMLString ? (
      <span class="message_title">{message}</span>
    ) : (
      <span class="message_title" vHtml={message}></span>
    );

    return (
      <transition name="close_message_slide" onAfter-leave={handleAfterLeave}>
        <div
